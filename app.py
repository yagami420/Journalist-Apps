...
# SEARCH FOR TORNADO IMAGE (1.jpeg) IN PROJECT DIRECTORY
go_icon_b64 = ""
for img_file in ["1.jpeg", "1.jpg", "1.png"]:
    img_path = os.path.join(os.path.dirname(__file__), img_file) if "__file__" in locals() else img_file
...
# BASE CSS WITH SPECIALIZED BUTTON STYLING
go_button_css = ""
if go_icon_b64:
    go_button_css = f"""
        button[aria-label="Go"] {{
            background-image: url('data:image/jpeg;base64,{go_icon_b64}') !important;
        ...
        button[aria-label="Go"]:hover {{
            transform: scale(1.12) !important;
            background-color: transparent !important;
            border: none !important;
            box-shadow: none !important;
        }}
        button[aria-label="Go"] p {{
...
st.markdown(f"""
    <style>
        /* HIDE STREAMLIT DECORATION / TOOLBARS / HEADER ARTIFACTS */
        ...
        /* OVERRIDE FOR TORNADO GO BUTTON */
        {go_button_css}
