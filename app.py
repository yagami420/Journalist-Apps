...
# PURE GOOGLE-WHITE STYLING WITH EXACT GOOGLE VERTICAL CENTERING (20VH TOP OFFSET)
st.markdown("""
    <style>
        /* HIDE ALL STREAMLIT DECORATION / HEADER ARTIFACTS */
        ...
        /* GOOGLE.COM EXACT VERTICAL OFFSET (20VH LOWER POSITIONING) */
        .block-container {
