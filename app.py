...
logo_html = """
<div style="text-align: center; margin-top: 20px; margin-bottom: 25px; select-user: none; cursor: default;">
...
# Render premium output text areas with Copy buttons inside iframe
def render_copiable_box(label, text, height=120):
    # Safe javascript string parsing
