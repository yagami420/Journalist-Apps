...
# PURE GOOGLE-WHITE STYLING (NO OVERLAPS / NO DARK THEMES)
st.markdown("""
    <style>
        ...
        /* STRICT PURE WHITE BACKGROUND FOR ENTIRE APPLICATION */
        ...
        /* GOOGLE.COM POSITIONING (LOWER ON SCREEN) */
        .block-container {
        ...
        /* GOOGLE SEARCH BAR INPUT STYLING */
...
if not st.session_state.logged_in:
    ...
    with login_center_col2:
        ...
        # LOGO DISPLAY (NO WRAPPER CARD DIV)
...
# --- 7. RENDER MAIN WORKSPACE (GOOGLE CENTERED & SPACIOUS) ---
    ...
    with main_col:
        ...
        if os.path.exists(logo_path):
            with open(logo_path, "rb") as img_file:
                img_b64 = base64.b64encode(img_file.read()).decode()
            st.markdown(f'<div style="display: flex; justify-content: center; align-items: center; margin-bottom: 30px; width: 100%;"><img src="data:image/png;base64,{img_b64}" style="max-width: 340px; width: 100%;" /></div>', unsafe_allow_html=True)
        else:
