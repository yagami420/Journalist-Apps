...
# PURE GOOGLE-WHITE STYLING WITH EXACT GOOGLE SEARCH BAR UI
st.markdown("""
    <style>
        /* HIDE ALL STREAMLIT DECORATION */
        ...
        /* GOOGLE HOMEPAGE EXACT 20VH TOP OFFSET */
        .block-container {
        ...
        /* EXACT GOOGLE SEARCH BAR STYLING WITH EMBEDDED SEARCH SVG ICON */
        div[data-testid="stTextInput"] input {
            ...
            background-color: #ffffff !important;
            background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 24 24' fill='none' stroke='%239aa0a6' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><circle cx='11' cy='11' r='8'></circle><line x1='21' y1='21' x2='16.65' y2='16.65'></line></svg>") !important;
        ...
        div[data-testid="stTextInput"] input:hover, div[data-testid="stTextInput"] input:focus {
            box-shadow: 0 1px 6px rgba(32,33,36,0.28) !important;
            border-color: rgba(223,225,229,0) !important;
            outline: none !important;
        }
        
        /* CENTERED GOOGLE ACTION BUTTON BELOW SEARCH BAR */
...
# --- 6. RENDER SECURE GATE (LOGIN PAGE - LOWER POSITIONED LIKE GOOGLE) ---
...
# --- 7. RENDER MAIN WORKSPACE (GOOGLE CENTERED & SPACIOUS) ---
    ...
    with main_col:
        ...
        if os.path.exists(logo_path):
            with open(logo_path, "rb") as img_file:
                img_b64 = base64.b64encode(img_file.read()).decode()
            st.markdown(f'<div style="display: flex; justify-content: center; align-items: center; margin-bottom: 25px; width: 100%;"><img src="data:image/png;base64,{img_b64}" style="max-width: 320px; width: 100%;" /></div>', unsafe_allow_html=True)
        else:
            st.markdown('<div style="display: flex; justify-content: center; align-items: center; margin-bottom: 25px; width: 100%;"><div style="text-align: center; color: #1a73e8;"><h1 style="margin: 0; font-family: Google Sans, Roboto, sans-serif; font-size: 3rem;">🌪️ جل بگولہ</h1></div></div>', unsafe_allow_html=True)
        
        # EXACT GOOGLE SEARCH BAR UI
        user_input = st.text_input("Search", placeholder="Paste a news link or text summary here...", label_visibility="collapsed")
        
        btn_col1, btn_col2, btn_col3 = st.columns([2, 1.5, 2])
        with btn_col2:
            go_pressed = st.button("Google Search", type="primary", use_container_width=True)
