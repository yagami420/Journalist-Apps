...
def process_with_groq(text, api_key):
    ...
    system_prompt = (
        ...
        "1. \"headline\": A highly comprehensive and impactful Urdu bulletin headline using short, punchy sentences. Avoid long or winding sentence structures. Keep the overall text volume clean and concise—around 70% of a massive single paragraph block—optimized for quick live delivery. No English words, Cyrillic characters, or western digits. Write numbers in Urdu words.\n"
...
# --- 7. RENDER MAIN WORKSPACE (WHEN LOGGED IN) ---
    ...
    with main_col:
        ...
        if st.session_state.headline or st.session_state.package or st.session_state.oc_vo:
            ...
            # Re-optimized layout heights to fit the sleek 70% compact punchy headline structure
