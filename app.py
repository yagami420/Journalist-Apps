...
# --- 3. FREE OPENAI CHATGPT PROCESSOR WITH NEW MASTER PROMPT ---
def process_with_master_prompt(text, token):
    ...
    # NEW MASTER PROMPT (TV NEWSROOM EDITOR)
    system_prompt = (
    ...
    payload = {
        ...
        "messages": [
            ...
            {"role": "user", "content": f"درج ذیل مواد کو نیوز روم فارمیٹ میں تبدیل کریں:\n\n{text}"}
        ],
        "temperature": 0.0,
